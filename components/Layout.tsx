      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          <Link href="/" className="flex items-center gap-2 flex-shrink-0">
            ...
            <span className="text-xl font-bold tracking-tight text-zinc-900 dark:text-white">宠物领养平台</span>
          </Link>
          <div className="flex items-center gap-8">
              ...
              {navLinks.map((link) => (
                <Link
                  ...
                  className={`text-sm font-semibold hover:text-primary transition-colors whitespace-nowrap ${
                    pathname === link.path ? 'text-primary relative after:content-[""] after:absolute after:-bottom-5 after:left-0 after:w-full after:h-0.5 after:bg-primary' : 'text-gray-600 dark:text-gray-300'
                  }`}
                >
                  {link.label}
                </Link>
            ...
            <div className="flex items-center gap-4 flex-shrink-0">
              <Link href="/messages" className="relative p-1.5 text-gray-500 dark:text-gray-400 hover:text-primary transition-colors">
                <Bell />
              ...
              <div className="relative">
                ...
                >
                  <img alt="User Avatar" className="w-full h-full object-cover" src="https://lh3.googleusercontent.com/aida-public/AB6AXuAENamW342ZFfMNyUzH4RG-QF7g8TUVjR___dGsbSN12zedWRotmJzGNYQsElkSUQZEe5vnmzNFUTmqW46qNempW4hLwx1j9lAGE70VQCpJXqcZ4lmq3oJEVN3iqsXGXCh6CNp0eQllWGE68jAi-Je1N0kIfK5uhUTZiG2mpHREZcw4osYs5446h-ElGUt3q8Kvap7s8wbbtEcnIs1452p60vkWMzekjlpARH51GFJ3meD3GbvEOW2tWU6xlu_kD3DB5W7IFzXso_c"/>
                </div>
                ...
                {showUserMenu && (
                  <div className="absolute right-0 mt-2 w-48 bg-white dark:bg-zinc-900 rounded-xl shadow-xl border border-gray-100 dark:border-white/10 py-2 z-50">
                    <Link href="/login" onClick={() => setShowUserMenu(false)} className="flex items-center gap-2 px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-white/5 transition-colors">
                      <LogIn className="text-sm" /> 登录/注册
                    </Link>
                    <Link href="/change-password" onClick={() => setShowUserMenu(false)} className="flex items-center gap-2 px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-white/5 transition-colors">
                      <Lock className="text-sm" /> 修改密码
                    </Link>
                    <div className="h-px bg-gray-100 dark:bg-white/5 my-1 mx-2"></div>
                    <button onClick={() => {setShowUserMenu(false); router.push('/login')}} className="w-full flex items-center gap-2 px-4 py-2 text-sm text-red-500 hover:bg-red-50 dark:hover:bg-red-500/10 transition-colors">
  ...
  <footer className="bg-white dark:bg-white/5 border-t border-[#e6dedb] dark:border-white/10 pt-16 pb-8">
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
        ...
        <div>
          ...
          <ul className="space-y-4 text-sm text-gray-500 dark:text-gray-400">
            ...
            <li><Link href="/pets" className="hover:text-primary transition-colors">宠物列表</Link></li>
            <li><Link href="/publish" className="hover:text-primary transition-colors">发布宠物</Link></li>
            <li><Link href="/my-applications" className="hover:text-primary transition-colors">领养申请</Link></li>
          </ul>
        </div>
        <div>
          ...
          <ul className="space-y-4 text-sm text-gray-500 dark:text-gray-400">
            ...
            <li><button className="hover:text-primary transition-colors">安全建议</button></li>
        ...
        <div>
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 mb-4">加入我们的社区，获取宠物护理技巧和最新的领养动态。</p>
          <div className="flex gap-2">
            <input className="flex-1 bg-[#f5f1f0] dark:bg-white/5 border-none rounded-xl text-sm focus:ring-primary h-11 px-4" placeholder="电子邮箱" type="email"/>
      ...
      <div className="border-t border-[#e6dedb] dark:border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
        <p className="text-xs text-gray-500 dark:text-gray-400">© 2024 宠物领养平台。自 2010 年起为宠物寻找温暖的家。</p>
